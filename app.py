...
app.config['MAIL_USERNAME'] = 'sangrampany3040@gmail.com'  
app.config['MAIL_PASSWORD'] = 'kkgk ykgb xvoz jnsq'  
app.config['MAIL_DEFAULT_SENDER'] = 'sangrampany3040@gmail.com'  
